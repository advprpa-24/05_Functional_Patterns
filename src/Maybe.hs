...
data Account = MkAccount { userId :: Int, balance :: Double } deriving (Show, Eq)
...
-- userIdByEmail "daniel.kroeni@fhnw.ch"
-- fmap accountByUserId (userIdByEmail "daniel.kroeni@fhnw.ch")
